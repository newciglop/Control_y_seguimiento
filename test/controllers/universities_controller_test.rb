...
class UniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university" do
    assert_difference('University.count') do
      post universities_url, params: { university: { address: @university.address, agreement: @university.agreement, contact: @university.contact, contact_phone: @university.contact_phone, enable: @university.enable, name: @university.name, phone: @university.phone } }
    end
  ...
  test "should update university" do
    patch university_url(@university), params: { university: { address: @university.address, agreement: @university.agreement, contact: @university.contact, contact_phone: @university.contact_phone, enable: @university.enable, name: @university.name, phone: @university.phone } }
