...
class UniversitiesTest < ApplicationSystemTestCase
  ...
  test "creating a University" do
    ...
    fill_in "Agreement", with: @university.agreement
    fill_in "Contact", with: @university.contact
    fill_in "Contact phone", with: @university.contact_phone
    check "Enable" if @university.enable
    fill_in "Name", with: @university.name
    fill_in "Phone", with: @university.phone
